...
GFF.items = [
{
	...
	"title": "gbXML.org sample files",
		"subTitle":
			`Files from the <a href="https://github.com/GreenBuildingXML/Sample_gbXML_Files" target="_blank">gbXML.org Sample Files</a>
...
GFF.getMenuGithubFoldersFiles = function() {
	...
	htm = GFF.items.map ( ( item, index ) => GFF.getDetails( item, index ) )
	return htm.join( " " );
